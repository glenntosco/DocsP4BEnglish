---
description: Electronic Invoicing Panama
---
...
{% hint style="info" %}
If you are selling to the Government of Panama you will need to select the proper product code from the PDF above. Failure to enter a product category code will cause Government invoices to fail.
{% endhint %}
